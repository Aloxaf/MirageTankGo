...
class MirageTankGoGUI:
    def __init__(self, top=None):
        ...
        self.TNotebook1.place(relx=0.53, rely=0.04, relheight=0.25
                , relwidth=0.42)
        ...
        self.blackLight.place(relx=0.35, rely=0.4, relheight=0.17, relwidth=0.46)
        ...
        self.tNo38_t0_che50 = Checkbutton(self.TNotebook1_t0)
        self.tNo38_t0_che50.place(relx=0.09, rely=0.13, relheight=0.17
                , relwidth=0.31)
        # self.tNo38_t0_che50.configure(activebackground="#d9d9d9")
        self.tNo38_t0_che50.configure(justify=RIGHT)
        self.tNo38_t0_che50.configure(text='''开启棋盘格''')
        self.tNo38_t0_che50.configure(variable=MainWindow_support.che50)

        self.whiteColor = Spinbox(self.TNotebook1_t1, from_=0.0, to=1.0)
        self.whiteColor.place(relx=0.35, rely=0.4, relheight=0.17, relwidth=0.46)
        ...
        self.blackColor.place(relx=0.35, rely=0.67, relheight=0.17
                , relwidth=0.46)
        ...
        self.blackLight_c.place(relx=0.35, rely=0.13, relheight=0.17
                , relwidth=0.46)
        ...
        self.blackLight_c.configure(textvariable=MainWindow_support.blackLight_c)
