...
class MirageTankGoGUI:
    def __init__(self, top=None):
        ...
        self.TNotebook1.place(relx=0.53, rely=0.04, relheight=0.23
                , relwidth=0.42)
        ...
        self.TNotebook1_t1.configure(width=310)
        ...
        self.Label7.place(relx=0.12, rely=0.43, height=24, width=68)
        self.Label7.configure(text='''黑底亮度:''')

        self.che50 = IntVar()
        self.enableChess = Checkbutton(self.TNotebook1_t0)
        self.enableChess.place(relx=0.09, rely=0.14, relheight=0.19
                , relwidth=0.31)
        self.enableChess.configure(activebackground="#d9d9d9")
        self.enableChess.configure(justify=RIGHT)
        self.enableChess.configure(state=ACTIVE)
        self.enableChess.configure(text='''开启棋盘格''')
        self.enableChess.configure(variable=self.che50)
        ...
        self.Label5.place(relx=0.12, rely=0.14, height=24, width=68)
        self.Label5.configure(activebackground="#f9f9f9")
        self.Label5.configure(text='''黑底亮度:''')

        self.Label6 = Label(self.TNotebook1_t1)
        self.Label6.place(relx=0.12, rely=0.43, height=24, width=68)
        self.Label6.configure(activebackground="#f9f9f9")
        self.Label6.configure(text='''白底色彩:''')

        self.Label4 = Label(self.TNotebook1_t1)
        self.Label4.place(relx=0.12, rely=0.71, height=24, width=68)
        self.Label4.configure(text='''黑底色彩:''')
        self.Label4.configure(width=68)
